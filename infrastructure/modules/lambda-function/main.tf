...
resource "aws_lambda_function" "this" {
  ...
  layers = concat([
    ...
    "arn:aws:lambda:${data.aws_region.this.name}:094274105915:layer:AWSLambdaPowertoolsTypeScript:11",
    ], var.enable_param_store_secrets_extension ? [
    # See: https://docs.aws.amazon.com/secretsmanager/latest/userguide/retrieving-secrets_lambda.html
    local.aws_parameters_and_secrets_lambda_extension_arn[data.aws_region.this.name]
  ] : [])
